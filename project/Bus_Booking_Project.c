...
int main()
{
    ...
    do{
        ...
        printf("\n");
        printf("\t\t\t\t\t3.  Cancel Booked Seats\n");
        printf("\n");
        printf("\t\t\t\t\t4.  Check status of the Buses\n");
        printf("\n");
        printf("\t\t\t\t\t5.  Exit\n\n");
        printf("------------------------------------------------------------------------------------------------------------------\n\n");
...
void booking()
{
    ...
    {
        printf("\n\n\n\t\t\t\tAvailable Seats:------>%d\n",seat1);
        printf("\n\t\t\t\tPlease type the Number of Tickets:----->");
        scanf("%d",&booking);
        printf("\n");
...
void name_number(int booking,char numstr[100])
{
    ...
    a = fopen(tempstr1,"a");//open the file to write the name in the file
    b = fopen(tempstr2,"a");//open the file for writing the number in the file
    for(i=0; i<booking; i++)//enter the person name and seat number in the file
    {
...
int read_number(int trno)//putting the numeric value in the array
{
    ...
    do
{
	...
	if(a>2)
	{
		printf("\nYou entered the wrong username and password three times.");
		getch();
        exit(1);
